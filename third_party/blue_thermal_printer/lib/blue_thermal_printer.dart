...
class BlueThermalPrinter {
  ...
  static const EventChannel _scaleReadChannel =
      const EventChannel('$namespace/scale_read');
  ...
  ///onScaleRead()
  Stream<String> onScaleRead() => _scaleReadChannel
  ...
  Future<bool?> get isScaleConnected async =>
      await _channel.invokeMethod('isScaleConnected');
  ...
  ///connectScale(BluetoothDevice device)
  Future<dynamic> connectScale(BluetoothDevice device) =>
      _channel.invokeMethod('connectScale', device.toMap());

  ///disconnect()
  Future<dynamic> disconnect() => _channel.invokeMethod('disconnect');

  ///disconnectScale()
  Future<dynamic> disconnectScale() => _channel.invokeMethod('disconnectScale');
